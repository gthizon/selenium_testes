...
import static br.com.projedata.arcturus.teste.webelements.WizardRelatoriosElementos.abrirArvoreComponentes;
import static br.com.projedata.arcturus.teste.webelements.WizardRelatoriosElementos.abrirArvoreComponentesGrafico;
import static br.com.projedata.arcturus.teste.webelements.WizardRelatoriosElementos.abrirArvoreRodape;
import static br.com.projedata.arcturus.teste.webelements.WizardRelatoriosElementos.abrirPropriedadesSerieGrafico;
import static br.com.projedata.arcturus.teste.webelements.WizardRelatoriosElementos.abrirPropriedadesValorGrafico;
...
import static br.com.projedata.arcturus.teste.webelements.WizardRelatoriosElementos.etiquetaCasasDecimais;
import static br.com.projedata.arcturus.teste.webelements.WizardRelatoriosElementos.etiquetaExibirSeparadorDecimal;
...
import static br.com.projedata.arcturus.teste.webelements.WizardRelatoriosElementos.legendaMascara;
...
import static br.com.projedata.arcturus.teste.webelements.WizardRelatoriosElementos.propriedadeEtiquetaCasasDecimais;
import static br.com.projedata.arcturus.teste.webelements.WizardRelatoriosElementos.propriedadeLegendaExibirSerie;
import static br.com.projedata.arcturus.teste.webelements.WizardRelatoriosElementos.propriedadeLegendaMascara;
import static br.com.projedata.arcturus.teste.webelements.WizardRelatoriosElementos.quadroCamposGrupoSelecionados;
import static br.com.projedata.arcturus.teste.webelements.WizardRelatoriosElementos.quadroRepeticaoGrafico;
...
import static br.com.projedata.arcturus.teste.webelements.WizardRelatoriosElementos.wizardAssistente;
...
public class TesteWizardRelatorios extends TesteGenerico {
	...
	@Test(testName = "id: 1 - Testar a criacao de um novo relatorio", dependsOnMethods = { "abrirPger001" }, enabled = true)
	public void criarNovoRelatorio() {
		abaPrincipal = navegador.retornarPaginaAtual();
		ger001Metodos.criarNovoRelatorioParaEdicao(rotina);
	...
	@Test(testName = "id: 6 - Selecionar totalizadores funcao contar", dependsOnMethods = { "selecionarCamposGrupo" }, enabled = true)
	...
	@Test(testName = "id: 7 - Finalizar Wizard", dependsOnMethods = { "selecionarCamposTotalizadoresFuncaoContar" }, enabled = true)
	...
	public void finalizarWizardEAtualizarPagina() throws InterruptedException {
	...
	@Test(testName = "id: 8 - Emitir relatorio", dependsOnMethods = { "finalizarWizardEAtualizarPagina" }, enabled = true)
	public void emitirRelatorioTabular() throws InvalidPasswordException, IOException {
		...
		acao.limparElemento(filtroPeriodoInicial);
		teclado.pressionarTeclaDeControle(Keys.TAB);
		rotina.aguardarProcessarRotina();
		acao.escreverNoElemento(filtroPeriodoInicial, "01012016");
		teclado.pressionarTeclaDeControle(Keys.TAB);
		rotina.aguardarProcessarRotina();
		acao.limparElemento(filtroPeriodoFinal);
		teclado.pressionarTeclaDeControle(Keys.TAB);
		rotina.aguardarProcessarRotina();
	...
	@Test(testName = "id: 9 - Emitir relatorio no portal", dependsOnMethods = { "emitirRelatorioTabular" }, enabled = true)
	...
	public void finalizarVersaoEVerificarBotaoWizard() throws InterruptedException {
		rotina.aguardarProcessarRotina();
	...
	@Test(testName = "id: 10 - Excluir relatorio no portal", dependsOnMethods = { "cancelarVersaoEVerificarBotaoWizard" }, enabled = true)
	public void excluirRelatorioNoPortal() {
		rotina.aguardarProcessarRotina();
		ger001Metodos.excluirRelatorio(rotina);
	}

	@Test(testName = "id: 11 - Criar relatorio do tipo grafico linha", dependsOnMethods = { "excluirRelatorioNoPortal" }, enabled = true)
	...
	@Test(testName = "id: 12 - Cadastrar consulta grafico linha", dependsOnMethods = { "criarRelatorioGraficoLinha" }, enabled = true)
	...
	@Test(testName = "id: 13 - Selecionar campos grafico linha", dependsOnMethods = { "cadastrarConsultaGraficoLinha" }, enabled = true)
	...
	@Test(testName = "id: 14 - Selecionar opcoes do grafico", dependsOnMethods = { "selecionarCamposGraficoLinha" }, enabled = true)
	public void configurarGraficoLinha() {
		...
		acao.posicionarFocoNoElemento(rotina, selecionarCategoria);
		acao.selecionarNoElementoPeloValor(selecionarCategoria, "string:inicio");
		acao.posicionarFocoNoElemento(rotina, selecionarSerie);
	...
	@Test(testName = "id: 15 - Finalizar wizard e gerar relatorio", dependsOnMethods = { "configurarGraficoLinha" }, enabled = true)
	...
	@Test(testName = "id: 16 - Criar relatorio grafico de barras", dependsOnMethods = { "finalizarGraficoEGerarRelatorio" }, enabled = true)
	...
	@Test(testName = "id: 17 - Selecionar consulta ja cadastrada", dependsOnMethods = { "criarRelatorioGraficoBarras" }, enabled = true)
	...
	@Test(testName = "id: 18 - Selecionar campos grafico barras", dependsOnMethods = { "selecionarConsultaGraficoBarras" }, enabled = true)
	...
	@Test(testName = "id: 19 - Configurar grafico barras", dependsOnMethods = { "selecionarCamposGraficoBarras" }, enabled = true)
	public void configurarGraficoBarras() {
		...
		acao.posicionarFocoNoElemento(rotina, selecionarCategoriaGraficoBarras);
	...
	@Test(testName = "id: 20 - Selecionar filtros grafico barras", dependsOnMethods = { "configurarGraficoBarras" }, enabled = true)
	...
	@Test(testName = "id: 21 - Gerar relatorio grafico barras", dependsOnMethods = { "selecionarFiltroGraficoBarras" }, enabled = true)
	public void emitirRelatorioGraficoBarras() throws InvalidPasswordException, IOException {
		finalizarGraficoEGerarRelatorio();
	}

	@Test(testName = "id: 22 - Criar relatorio grafico de pizza", dependsOnMethods = { "emitirRelatorioGraficoBarras" }, enabled = true)
	...
	@Test(testName = "id: 23 - Selecionar consulta ja cadastrada", dependsOnMethods = { "criarRelatorioGraficoPizza" }, enabled = true)
	...
	@Test(testName = "id: 24 - Selecionar campos grafico pizza", dependsOnMethods = { "selecionarConsultaGraficoPizza" }, enabled = true)
	...
	@Test(testName = "id: 25 - Configurar grafico pizza", dependsOnMethods = { "selecionarCamposGraficoPizza" }, enabled = true)
	public void configurarGraficoPizza() {
		acao.posicionarFocoNoElemento(rotina, selecionarValorGraficoPizza);
		acao.selecionarNoElementoPeloValor(selecionarValorGraficoPizza, "string:max_numero_os");
		acao.posicionarFocoNoElemento(rotina, selecionarSerieGraficoBarras);
	...
	@Test(testName = "id: 26 - Selecionar filtros grafico pizza", dependsOnMethods = { "configurarGraficoPizza" }, enabled = true)
	public void selecionarFiltrosGraficoPizza() {
		selecionarFiltroGraficoBarras();
	}

	@Test(testName = "id: 27 - Gerar relatorio grafico pizza", dependsOnMethods = { "selecionarFiltrosGraficoPizza" }, enabled = true)
	public void emitirRelatorioGraficoPizza() throws InvalidPasswordException, IOException {
		finalizarGraficoEGerarRelatorio();
	}

	@Test(testName = "id: 28 - Criar relatorio matriz", dependsOnMethods = { "emitirRelatorioGraficoPizza" }, enabled = true)
	...
	@Test(testName = "id: 29 - Selecionar consulta ja cadastrada", dependsOnMethods = { "criarRelatorioMatriz" }, enabled = true)
	...
	@Test(testName = "id: 30 - Selecionar campos matriz", dependsOnMethods = { "selecionarConsultaMatriz" }, enabled = true)
	...
	@Test(testName = "id: 32 - Selecionar totalizadores matriz", dependsOnMethods = { "configurarMatriz" }, enabled = true)
	...
	@Test(testName = "id: 33 - Selecionar filtros matriz", dependsOnMethods = { "selecionarTotalizadoresMatriz" }, enabled = true)
	public void selecionarFiltrosMatriz() {
		selecionarFiltroGraficoBarras();
	}

	@Test(testName = "id: 34 - Gerar relatorio matriz", dependsOnMethods = { "selecionarFiltrosMatriz" }, enabled = true)
	...
	public void verificarSePropriedadesDoGraficoForamCriadasCorretamente() throws InvalidPasswordException, IOException {
		...
		teclado.pressionarTeclaDeControle(Keys.TAB);
		String mascaraEtiqueta = acao.localizarElemento(legendaMascara).getAttribute("value");
		acao.clicarNoElemento(botaoAvancarWizard);
		espera.aguardarElementoEstarVisivel(abaGruposGraficoLinha);
		acao.clicarNoElemento(botaoAvancarWizard);
		espera.aguardarElementoEstarVisivel(botaoFinalizarAssistente);
