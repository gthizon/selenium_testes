...
public class Mensagem extends br.com.projedata.teste.util.recursos.Mensagem {

	public Mensagem(WebDriver driver, Teclado teclado) {
		super(driver, teclado);
	}
	...
	public By mensagemNenhumRegistroAlterado = By.xpath("//*[contains(text(),'Nenhum registro alterado')]");
	...
	public By simConfirmacao = By.xpath("//button[@class='btn-sim atalho-s' or @data-type='sim' or contains(@class,'btn-yes') or contains(@class,'atalho-s')]");
	public By naoConfirmacao = By.xpath("//button[contains(@class,'atalho-n') or @data-type='nao']");
