...
//		this.mouse = teste.mouse;
	...
	public static By selecionarOpcaoObjetoNegocio = By
			.xpath("//td[text()='ARCOBJETONEGOCIO' and (@class='ng-binding ng-scope')]");
	public static By lovModificacaoCadastro = By
			.xpath("//ol[@class='mod-cadastro-progress']//ancestor::a[text()='ARCOBJETONEGOCIO']");
	...
	public static By abrirRascunhoConstrutorModoListagem = By
			.xpath("//div[contains(@class, 'rascunho-table')]//parent::td[text()='pteste014']");
